...
namespace CarouselView
{
    class MainViewForms:ContentPage
    {
        ...
        private void SetupBox2(ContentView box)
        {
            ...
            box.Content = new Label { Text = "Title 3", TextColor = Color.White };
        }
        ...
        private void SetupBox4(ManualCarouselView box)
        {
            ...
            pg1.PageAppearing += () => {
                Device.BeginInvokeOnMainThread(() => {
                    lb1.Text = String.Format("{0} {1}", "Title 8", ++timesTileHasChanged);
                });
            };
            pg2.PageAppearing += () => {
                Device.BeginInvokeOnMainThread(() => {
                    lb2.Text = String.Format("{0} {1}\n\n{2}", "Title 9.1", ++timesTileHasChanged, "Title 2");
                });
            };
        ...
        {
            box.Padding = new Thickness(5);
            box.Content = new Label { Text = "Text 1", TextColor = Color.White };
        }
    }
}
